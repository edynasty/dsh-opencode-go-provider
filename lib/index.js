...
function toPiModel(model) {
	const thinkingLevelMap = (model.reasoningOptions?.find((option) => option.kind === "effort"))?.values.reduce((map, level) => {
	...
	return {
		...
		...thinkingLevelMap === void 0 || Object.keys(thinkingLevelMap).length === 0 ? {} : { thinkingLevelMap },
